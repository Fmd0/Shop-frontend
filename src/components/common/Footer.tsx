...
const Footer = () => {
    return (
        <div className="grid auto-rows-auto lg:grid-cols-2 gap-8 mt-20 mb-40">

            <div className="md:hidden h-4 bg-[rgb(242_244_245)]"></div>
            ...
            {/*right part*/}
            <div className="px-4 lg:w-3/4 grid auto-rows-auto md:grid-cols-3 gap-4 text-[rgb(111_112_113)] text-[14px]">
