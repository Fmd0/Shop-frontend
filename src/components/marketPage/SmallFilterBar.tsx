        ...
        <div className="relative flex md:hidden items-center justify-between">
            ...
            {/*tag list or text products*/}
            {
                marketInfo?.marketTag?.tags && marketInfo.marketTag.tags.length > 0
                    ? <div
                        className="overflow-auto no-scrollbar pr-12 flex items-center gap-4 text-[rgb(111_112_113)] text-[17px] tracking-[0.15px]">
            ...
            <button type="button"
                    className="flex-shrink-0 size-8 rounded-[999px] border-[1px] border-[#0000001a] duration-200 hover:bg-[#0000001a] flex items-center justify-center"
                    onClick={(event) => {
            ...
            <div className="absolute top-0 right-8 w-20 h-full bg-[linear-gradient(to_right,rgba(255,255,255,0)_0%,rgb(255,255,255)_100%)]"></div>
