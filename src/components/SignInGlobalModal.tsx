...
const SignInGlobalModal = () => {
    const {signInModalOpen: modalOpen, closeSignInModal: closeModal, setEmail, setLike} = useUserInfoStore();
    ...
    return (
        ...
        duration-200 ${modalOpen?"opacity-100":"opacity-0 pointer-events-none"}`}
            ...
            <div className={`w-4/5 max-w-[340px] tracking-[.15px] bg-white rounded-3xl overflow-hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
            ...
            onClick={e => e.stopPropagation()}>
                ...
                <div className="px-4 py-6">
                    <form className="border-neutral-300 overflow-hidden" onSubmit={handleSubmit}>
                        {
                            isSignIn
                                ? <div key="signIn" className="flex flex-col gap-[18px]">
                                ...
                                : <div key="register" className="flex flex-col gap-[18px]">
                                    <div className="relative">
                                        <input type="email"
                                               name="email"
                                               className="focus:pt-6 inputHasText focus:pb-2 py-4 px-5 w-full duration-200 focus:placeholder:text-white placeholder:text-neutral-500 transition-[border] focus:outline-none focus:border-[rgb(84,51,235)] border-neutral-400 border-[1px] rounded-[16px] text-[14px] font-normal peer"
                        ...
                        <button type="submit"
                                ...
                                className="cursor-pointer w-full rounded-xl bg-[rgb(94,63,235)] duration-200 hover:bg-[rgb(127,104,233)] text-white py-3 mt-4 grid place-items-center">
...
export default SignInGlobalModal;