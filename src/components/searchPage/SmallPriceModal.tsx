...
const PriceModal = () => {
    ...
    const {
        priceModalOpen: modalOpen,
        togglePriceModalOpen: toggleModalOpen,
        setStartPrice,
        setEndPrice
    } = useSearchInfoStore();
    ...
    return (
        <div
            ...
            <div
                ...
                <div className="grid grid-cols-[1fr_auto_1fr] gap-2 mb-6 items-center text-[14px] tracking-[0.15px]">
