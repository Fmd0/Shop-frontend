import SortByItem from "../marketPage/SortByItem.tsx";
...
const SortByModal = () => {
    ...
    const {
        sortByModalOpen: modalOpen,
        toggleSortByModalOpen: toggleModalOpen,
        setSortBy: setState
    } = useSearchInfoStore();
