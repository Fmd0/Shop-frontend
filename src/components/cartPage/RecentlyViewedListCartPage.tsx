...
const RecentlyViewedListCartPage = () => {
    ...
    return (
        <div className="w-[96%] max-w-[1144px] mx-auto tracking-[0.15px] font-medium mt-6 md:mt-12">

            {
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 md:gap-4 mt-3 md:mt-6">
                        {
