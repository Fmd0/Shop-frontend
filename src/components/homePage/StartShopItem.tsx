...
const StartShopItem = ({relativeId, logo, imageLeft, imageRight, name, rating,ratingAmount}: {
    ...
    return (
        <div
            className="relative flex-[1_1_0] rounded-xl bg-white overflow-hidden border-[1px] border-neutral-200 group/startShopItem">
            ...
            <div className="relative flex flex-row">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 size-11 bg-white rounded-lg overflow-hidden">
                    <img src={logo} alt="logo" className="w-full h-full object-contain"/>
                </div>
            </div>

            <a href={`/market?id=${relativeId}`}
               className="absolute top-0 left-0 w-full h-full bg-neutral-500 bg-opacity-0 duration-300 group-hover/startShopItem:bg-opacity-20 cursor-pointer"></a>
